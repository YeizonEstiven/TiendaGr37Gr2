            ...
            <section class="menu_container">
                ...
                <ul class="menu_links">
                    ...
                    <li class="menu_item menu_item--show">
                        <a href="datatableUser.jsp" class="menu_link">Usuarios <img src="icons/arrow.svg" class="menu_arrow"></a>
                        <ul class="menu_nesting">
                            <li class="menu_inside"><!--submenu-->
                                <a href="addUser.jsp" class="menu_link menu_link--inside">Crear</a>
                            </li>
                            <li class="menu_inside"><!--submenu-->
                                <a href="/ciclo3/listarUsuarios" class="menu_link menu_link--inside">Consultar</a>
                            </li>
                            <li class="menu_inside"><!--submenu-->
                                <a href="formCedulaUser.jsp" class="menu_link menu_link--inside">Actualizar</a>
                            </li>
                            <li class="menu_inside"><!--submenu-->
                    ...
                    <li class="menu_item menu_item--show">
                        <a href="datatableCliente.jsp" class="menu_link">Clientes <img src="icons/arrow.svg" class="menu_arrow"></a>
                        <ul class="menu_nesting">
                            <li class="menu_inside"><!--submenu-->
                                <a href="addCliente.jsp" class="menu_link menu_link--inside">Crear</a>
                            </li>
                            <li class="menu_inside"><!--submenu-->
                                <a href="/ciclo3/listarClientes" class="menu_link menu_link--inside">Consultar</a>
                            </li>
                            <li class="menu_inside"><!--submenu-->
                                <a href="formCedulaCliente.jsp" class="menu_link menu_link--inside">Actualizar</a>
                            </li>
                            <li class="menu_inside"><!--submenu-->
                                <a href="deleteCliente.jsp" class="menu_link menu_link--inside">Eliminar</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu_item menu_item--show">
                        ...
                        <ul class="menu_nesting">
                            <li class="menu_inside"><!--submenu-->
                                <a href="addProveedor.jsp" class="menu_link menu_link--inside">Crear</a>
                            </li>
                            <li class="menu_inside"><!--submenu-->
                                <a href="/ciclo3/listarProveedores" class="menu_link menu_link--inside">Consultar</a>
                            </li>
                            <li class="menu_inside"><!--submenu-->
                                <a href="formNitProveedor.jsp" class="menu_link menu_link--inside">Actualizar</a>
                            </li>
                            <li class="menu_inside"><!--submenu-->
                                <a href="deleteProveedor.jsp" class="menu_link menu_link--inside">Eliminar</a>
                            </li>
                        </ul>
                    </li>
